...
@implementation VivereViewController
...
- (void)viewDidLoad
{
    ...
    tlabel.text = NSLocalizedString(@"VIVERE", nil);
    ...
    latNumViv = [latFromCitySaved doubleValue];
    lngNumViv = [lonFromCitySaved doubleValue];
    
    CLLocationCoordinate2D centerCoord = CLLocationCoordinate2DMake(latNumViv, lngNumViv);
