//
//  VedereViewController.m //VISITARE
//  1000 Italy
//
...
@implementation VedereViewController
...
//        lonFromCitySaved = @"9.1833";
    ...
    [self getFeed:index]; // request listing data
    ...
    tlabel.text = NSLocalizedString(@"VISITARE", nil);
    ...
    // map view coords
//    latNumVed = [[[[self.listingNodesArray objectAtIndex:2] objectForKey:@"address"] objectForKey:@"lat"] doubleValue];
  //  lngNumVed = [[[[self.listingNodesArray objectAtIndex:2] objectForKey:@"address"] objectForKey:@"lng"] doubleValue];
    
    latNumVed = [latFromCitySaved doubleValue];
    lngNumVed = [lonFromCitySaved doubleValue];
    
    
    CLLocationCoordinate2D centerCoord = CLLocationCoordinate2DMake(latNumVed, lngNumVed);
