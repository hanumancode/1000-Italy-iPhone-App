...
@implementation ManigareViewController
...
//        
    ...
    tlabel.text = NSLocalizedString(@"MANGIARE", nil);
    ...
    // map view coords
   // latNumMang = [[[[self.listingNodesArray objectAtIndex:2] objectForKey:@"address"] objectForKey:@"lat"] doubleValue];
 //   lngNumMang = [[[[self.listingNodesArray objectAtIndex:2] objectForKey:@"address"] objectForKey:@"lng"] doubleValue];
    
    latNumMang = [latFromCitySaved doubleValue];
    lngNumMang = [lonFromCitySaved doubleValue];
    
    
    CLLocationCoordinate2D centerCoord = CLLocationCoordinate2DMake(latNumMang, lngNumMang);
